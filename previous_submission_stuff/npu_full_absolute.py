...
MIN_DURATION_MS = 10000  # In offline mode doesn't affect run (unless it's less than 10 sec), could just set it to 1
# Minimum query count
MIN_QUERY_COUNT = 50  # In offline mode doesn't affect run, could just set it to 1
